...
One of the resulting products from the ODOT Aerial Image section was a new GeoJSON containing historical streets in Cincinnati. This needed some preprocessing to use, namely it was missing intersections that had to be added. Next, I did some simple visualizations to show the historic grid next to and on top of the current street grid. Finally, I used this to conduct some street network analysis - showing how much disruption to the grid occurred.
